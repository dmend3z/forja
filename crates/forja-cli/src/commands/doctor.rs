...
pub fn run() -> Result<()> {
    ...
    // Check forja root
    let root_label = if paths.mode == forja_core::paths::ForjaMode::Project {
    ...
    let claude_label = if paths.mode == forja_core::paths::ForjaMode::Project {
    ...
    let agents_label = if paths.mode == forja_core::paths::ForjaMode::Project {
